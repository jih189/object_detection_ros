...
public:
	...
	// compute detection
	void SingleShapeDetectionWithVaryingQuerySize(LFLineFitter &lf, int tidx, double maxThreshold,vector<LMDetWind> &detWindArrays);
    void MultiShapeDetectionWithVaryingQuerySize(LFLineFitter &lf, double maxThreshold, vector<LMDetWind> &detWindArrays);
    void MultiShapeDetectionWithVaryingTemplateSize(LFLineFitter &lf, double maxThreshold, vector<LMDetWind> &detWindArrays);
...
#if 0
    void DetectBruteForce_omp(EIEdgeImage& dbImage, EIEdgeImage& queryImage, LMDistanceImage& queryDistanceImage, double detectionThreshold, double scale, MatchingCostMap &matchingCostMap, int &costMapIndex);
#endif
